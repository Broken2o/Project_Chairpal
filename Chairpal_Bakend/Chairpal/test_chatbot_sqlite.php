...
$doctor = User::create(['name' => 'Dr. Smith', 'email' => 'doc@test.com', 'password' => bcrypt('123'), 'role' => 'doctor', 'phone' => '+2011111111']);
$companion = User::create(['name' => 'Mona', 'email' => 'mona@test.com', 'password' => bcrypt('123'), 'role' => 'companion', 'phone' => '+2012222222']);
...
$trip = Trip::create([
    ...
    'user_id' => $user->id,
    'status' => 'in_progress',
    'place_id' => null, // Assuming place_id is the real column, not destination_place_id
]);
...
if ($wheelchair) {
    ...
    if ($tripCheck) {
        $currentTrip = [
            ...
            'destination' => $tripCheck->place_id ? 'Place ID: ' . $tripCheck->place_id : 'Unknown',
